        ...
        <div className="bg-white rounded-[10px] border border-slate-200 p-5 shadow-sm h-full flex flex-col hover:shadow transition-shadow">
            ...
            <div className="flex items-center justify-between mb-5 shrink-0">
                <div className="flex items-center">
                    ...
                    <h3 className="text-sm font-bold text-slate-800 tracking-tight">Avg. Days to Pay</h3>
                    <InfoTooltip content="The average number of days it takes for clients to pay their invoices after they are issued, indicating the speed of cash inflow." />
                </div>
