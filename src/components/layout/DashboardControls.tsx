    ...
    return (
        <div className="bg-white border-b border-slate-200 px-6 py-2.5 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <button
                    onClick={onSearch}
                    className="flex items-center gap-1.5 px-4 py-1.5 text-[11px] font-bold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-700 active:scale-95 transition-all"
                >
